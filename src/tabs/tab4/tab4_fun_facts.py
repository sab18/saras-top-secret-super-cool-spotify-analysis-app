...
fun_fact_list=[top_5_artists(),total_songs(), top10_songs(),total_listening_time(),first_song(),top10_songs_no1975(),top5_songs_senior_hs(),unique_countries(),percent_1975(),most_skipped(),most_seek_play(),top_3_consecutive_repeated_songs(),most_incognito()]